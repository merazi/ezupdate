...
# fields
names_label = ttk.Label(master=input_frame, text="Nombres").grid(
    row=1, column=0, padx=10, pady=5
)
names_entry = ttk.Entry(master=input_frame, textvariable=names).grid(
    row=1, column=1, padx=10, pady=5
)
lnames_label = ttk.Label(master=input_frame, text="Apellidos").grid(
    row=2, column=0, padx=10, pady=5
)
lnames_entry = ttk.Entry(master=input_frame, textvariable=lnames).grid(
    row=2, column=1, padx=10, pady=5
)
gender_label = ttk.Label(master=input_frame, text="Sexo").grid(
...
birthday_label = ttk.Label(master=input_frame, text="Fecha Nacimiento").grid(
    row=4, column=0, padx=10, pady=5
)
birthday_entry = ttk.Entry(master=input_frame, textvariable=birthday).grid(
    row=4, column=1, padx=10, pady=5
)
email_label = ttk.Label(master=input_frame, text="Email").grid(
    row=5, column=0, padx=10, pady=5
)
email_entry = ttk.Entry(master=input_frame, textvariable=email).grid(
    row=5, column=1, padx=10, pady=5
)
phone_label = ttk.Label(master=input_frame, text="Telefono").grid(
    row=6, column=0, padx=10, pady=5
)
phone_entry = ttk.Entry(master=input_frame, textvariable=phone).grid(
    row=6, column=1, padx=10, pady=5
)
address_label = ttk.Label(master=input_frame, text="Direccion").grid(
    row=7, column=0, padx=10, pady=5
)
address_entry = ttk.Entry(master=input_frame, textvariable=address).grid(
    row=7, column=1, padx=10, pady=5
)
civil_status_label = ttk.Label(master=input_frame, text="Estado Civil").grid(
...
# submit button
submit_button = ttk.Button(master=window, text="Submit", command=create_client).grid(
    row=2, column=0, padx=10, pady=5
)
window.mainloop()
