...
endpoint = "https://eojs1ez2lmnud8k.m.pipedream.net"
headers = {
...
def create_account_type(endpoint, headers):
    ...
    account_type_data = mj.build_account_type(val_account_type_desc,
...
# title
title_label = ttk.Label(master=window, text="Nuevo Tipo de Cuenta", font="Calibri 24 bold")
...
# submit button
submit_button = ttk.Button(master=window, text="Submit", command=lambda: create_account_type(endpoint, headers))
